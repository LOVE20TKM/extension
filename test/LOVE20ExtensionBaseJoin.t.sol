...
contract LOVE20ExtensionBaseJoinTest is BaseExtensionTest {
    ...
    function test_Join_Success() public {
        ...
        assertEq(extension.accountAtIndex(0), user1, "User1 should be first account");
    ...
    function test_Exit_Success() public {
        ...
        assertEq(extension.accountsCount(), 0, "Should have 0 accounts after exit");
        assertFalse(
            center.isAccountJoined(address(token), ACTION_ID, user1),
    ...
    function test_JoinedValue_EmptyAtStart() public view {
        assertEq(extension.joinedValue(), 0, "Joined value should be 0 initially");
    }
    ...
    function test_JoinedValue_AfterJoin() public {
        ...
        assertEq(extension.joinedValue(), 1, "Joined value should be 1 after one user joins");
    }
    ...
    function test_Center_Integration_AddAccount() public {
        ...
        uint256[] memory actionIds = center.actionIdsByAccount(address(token), user1);
